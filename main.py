    ...
    for sup in supp:
        for seq in sequences:
            for w in weights: 
                ...
                tracker.track(seq_path, fps=10, max_idx=10,delete_imgs=True,weights=w,ground_truth_filepath=ground_truth_filepath, conf=0.35, suppression=sup, std_deviations = STD_DEVIATIONS)

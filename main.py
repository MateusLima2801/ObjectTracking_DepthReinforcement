...
def main():
    ...
    STD_DEVIATIONS = [4.080301076630467,4.1468104706547075,0.4823281584040535,2.2988134815327603,4823.2815]
    sequences = ['uav0000297_02761_v']#,'uav0000077_00720_v', 'uav0000120_04775_v', 'uav0000201_00000_v', 'uav0000297_02761_v', 'uav0000119_02301_v']
    ...
    for sup in supp:
        for seq in sequences:
            for w in weights: 
                ...
                tracker.track(seq_path,DEPTH_SEQUENCE_FOLDER,fps=10, max_idx=None,delete_imgs=True,weights=w,ground_truth_filepath=ground_truth_filepath, conf=0.35, suppression=sup, std_deviations = STD_DEVIATIONS)

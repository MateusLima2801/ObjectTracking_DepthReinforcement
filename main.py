...
def main():
    ...
    sequences = ['uav0000009_03358_v','uav0000077_00720_v', 'uav0000120_04775_v', 'uav0000201_00000_v', 'uav0000370_00001_v', 'uav0000119_02301_v']
    done = []# [('uav0000077_00720_v',0),('uav0000077_00720_v',1),('uav0000120_04775_v', 0)]
    for sup in supp:
        for seq in sequences:
            for w in weights: 
                ...
                tracker.track(seq_path, fps=10, delete_imgs=True,weights=w,ground_truth_filepath=ground_truth_filepath, conf=0.35, suppression=sup, std_deviations = STD_DEVIATIONS)
